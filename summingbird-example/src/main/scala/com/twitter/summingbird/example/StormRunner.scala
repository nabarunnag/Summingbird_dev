...
object StormRunner {
  ...
  lazy val config = new ConfigurationBuilder()
    .setOAuthConsumerKey("XKv5XIQWn2vqnVGX4r9dl8keX")
    .setOAuthConsumerSecret("kz5mUWfiS6vJGelb405h9LRvEcJpglUpW1Kd6FroKjNPnpWAeP")
    .setOAuthAccessToken("68981433-8LsfmOWaW0rFrdUgiFn96DFlXUgMQSfCJQ0cgHJde")
    .setOAuthAccessTokenSecret("f0IUlw8KJnNaZfx5Riz6bc9qH2GUyB6c9aVw2zxAZOB98")
